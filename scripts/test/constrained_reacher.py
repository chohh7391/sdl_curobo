...
from sdl.utils.helper import add_extensions, add_robot_to_scene


parser = argparse.ArgumentParser()


parser.add_argument("--robot", type=str, default="fr5_ag95.yml", help="robot configuration to load")
